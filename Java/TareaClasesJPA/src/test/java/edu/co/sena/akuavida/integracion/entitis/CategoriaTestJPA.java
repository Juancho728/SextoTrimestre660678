...
//        em.getTransaction().begin();
    ...
    public void buscarCategoriaPorNombre() {
        ...
        String nombre = JOptionPane.showInputDialog("Escriba el nombre de la categoria");
        em = EntityManagerHelper.getEntityManager();
        EntityManagerHelper.beginTransaction();
        ...
        List<Categorias> lista = q.getResultList();
 ...
 @Test
    public void buscarPorActiva() {
        ...
        String activa = JOptionPane.showInputDialog("Insertar si esta activa o no la categoria");
