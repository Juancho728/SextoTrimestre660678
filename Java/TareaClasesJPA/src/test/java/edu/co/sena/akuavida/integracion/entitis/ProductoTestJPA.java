...
public class ProductoTestJPA {
    ...
    public void actualizarPkProducto() {
        em = EntityManagerHelper.getEntityManager();
        String nuevoIdPro = JOptionPane.showInputDialog("Digite el nuevo id del producto");
        String viejoIdPro = JOptionPane.showInputDialog("Digite el viejo id del producto ");

        String sql = "UPDATE akuavida.producto"
                + " SET"
                + " ID_producto = '"+ nuevoIdPro +"' "
                + " WHERE ID_producto = '" + viejoIdPro + "';";
